...
void _inferenceEntry(_InferenceRequest req) {
  ...
  try {
    ...
    debugPrint('[_inferenceEntry] Running interpreter...');
    interpreter.run(input, output);
    debugPrint('[_inferenceEntry] Inference complete');
    ...
    debugPrint('[_inferenceEntry] CRITICAL ERROR: $e');
    debugPrint('[_inferenceEntry] STACK TRACE: $stack');
