...
OUT    = os.path.normpath(os.path.join(BASE, "..", "..", "mobile_app", "assets", "model", "dermavision_optimized.tflite"))
LABELS = os.path.normpath(os.path.join(BASE, "..", "..", "mobile_app", "assets", "labels.json"))
...
CANDIDATES = [
    os.path.normpath(os.path.join(BASE, "..", "models", "fl_iid_model.keras")),
    os.path.normpath(os.path.join(BASE, "..", "models", "fl_noniid_model.keras")),
    os.path.normpath(os.path.join(BASE, "..", "models", "baseline_model.keras")),
]
