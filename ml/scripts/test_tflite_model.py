...
# Note: Reorganized structure: ml/scripts/ -> mobile_app/assets/...
MODEL_PATH = os.path.normpath(os.path.join(BASE, "..", "..", "mobile_app", "assets", "model", "dermavision_optimized.tflite"))
LABELS_PATH = os.path.normpath(os.path.join(BASE, "..", "..", "mobile_app", "assets", "labels.json"))
